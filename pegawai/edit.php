                ...
                <h6 class="heading-small text-muted mb-4">Pegawai information</h6>
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="name">Jenis Kelamin<span class="small text-danger">*</span></label>
                                        <?php $jk = $peg['jenis_kelamin']; ?>
                                        <select class="form-control" name="jenis_kelamin">
                                            <option <?php echo ($peg == 'Laki-laki') ? "selected": "" ?>>Laki-laki</option>
                                            <option <?php echo ($peg == 'Perempuan') ? "selected": "" ?>>Perempuan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
